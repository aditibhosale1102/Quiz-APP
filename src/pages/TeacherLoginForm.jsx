    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok && data.success) {
                localStorage.setItem("teacherName", data.user.username);
            ...
            localStorage.setItem("teacherName", "Admin");
            navigate("/admin/teachers");
        }
    };
        ...
        <>
            <div style={{
                ...
                <div style={{
                    ...
                    <h2 style={{ fontSize: "32px", marginBottom: "10px", letterSpacing: "1px" }}>TEACHER LOGIN</h2>
